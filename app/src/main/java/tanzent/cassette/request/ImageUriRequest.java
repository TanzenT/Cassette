...
import tanzent.cassette.bean.lastfm.LastFmAlbum;
import tanzent.cassette.bean.lastfm.LastFmArtist;
import tanzent.cassette.bean.mp3.Song;
import tanzent.cassette.bean.netease.NAlbumSearchResponse;
import tanzent.cassette.bean.netease.NArtistSearchResponse;
import tanzent.cassette.bean.netease.NSongSearchResponse;
...
import static tanzent.cassette.request.UriRequest.TYPE_NETEASE_ALBUM;
import static tanzent.cassette.request.UriRequest.TYPE_NETEASE_ARTIST;
import static tanzent.cassette.request.UriRequest.TYPE_NETEASE_SONG;
import static tanzent.cassette.util.Util.isWifi;

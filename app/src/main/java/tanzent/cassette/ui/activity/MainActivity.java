...
import tanzent.cassette.misc.update.DownloadService;
...
import static tanzent.cassette.bean.misc.Category.DEFAULT_LIBRARY;
import static tanzent.cassette.misc.update.DownloadService.ACTION_DISMISS_DIALOG;
import static tanzent.cassette.misc.update.DownloadService.ACTION_DOWNLOAD_COMPLETE;
import static tanzent.cassette.misc.update.DownloadService.ACTION_SHOW_DIALOG;
import static tanzent.cassette.util.ImageUriUtil.getSearchRequestWithAlbumType;
import static tanzent.cassette.util.Util.installApk;

...
import tanzent.cassette.misc.update.UpdateAgent;
import tanzent.cassette.misc.update.UpdateListener;
...
import tanzent.cassette.ui.dialog.ThemeDialog;
...
import static tanzent.cassette.bean.misc.Category.ALL_LIBRARY_STRING;
...
//                }
            ...
            case R.id.setting_feedback_container:
                try {
                    Toast.makeText(mContext, getString(R.string.opening_cassette_community_telegram), Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("tg://resolve?domain=cassette_community")));
                    ...
                    Toast.makeText(mContext, getString(R.string.telegram_not_installed), Toast.LENGTH_SHORT).show();
                }
                break;
            //检查更新
...
//                        deleteDatabase(DBOpenHelper.DBNAME);
    ...
    private void configLockScreen() {
        ...
        getBaseDialog(mContext)
                ...
                .items(new String[]{getString(R.string.cassette_lockscreen), getString(R.string.system_lockscreen), getString(R.string.close)})

...
import tanzent.cassette.misc.interfaces.OnModeChangeListener;
...
public class DrawerAdapter extends BaseAdapter<Integer, DrawerAdapter.DrawerHolder> {
    ...
    private int[] IMAGES = new int[]{R.drawable.drawer_icon_musicbox, R.drawable.drawer_icon_recently,
            R.drawable.drawer_icon_night, R.drawable.darwer_icon_set,
            R.drawable.drawer_icon_exit};
    private int[] TITLES = new int[]{R.string.drawer_song, R.string.drawer_recently, R.string.drawer_night, R.string.drawer_setting, R.string.exit};

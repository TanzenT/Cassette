...
public class Constants {
    //应用包名
    public final static String PACKAGE_NAME = "tanzent.cassette";
    //播放队列
    ...
    public final static String EXIT = "tanzent.music.EXIT";
    public final static String SOUNDEFFECT_ACTION = "tanzent.music.SOUNDEFFECT_ACTION";
    public final static String TAG_EDIT = "tanzent.music.TAG_EDIT";

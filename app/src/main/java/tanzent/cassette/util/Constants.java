...
public class Constants {
  ...
  public final static String EXIT = "tanzent.cassette.EXIT";
  public final static String SOUNDEFFECT_ACTION = "tanzent.cassette.SOUNDEFFECT_ACTION";
  ...
  //0:软件锁屏 1:系统锁屏 2:关闭
  public final static int CASSETTE_LOCKSCREEN = 0;

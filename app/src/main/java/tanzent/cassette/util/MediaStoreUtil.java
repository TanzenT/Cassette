...
import static tanzent.cassette.util.Util.TYPE_ALBUM;
import static tanzent.cassette.util.Util.TYPE_ARTIST;
import static tanzent.cassette.util.Util.TYPE_DISPLAYNAME;
import static tanzent.cassette.util.Util.TYPE_SONG;
import static tanzent.cassette.util.Util.hasStoragePermissions;
import static tanzent.cassette.util.Util.processInfo;
